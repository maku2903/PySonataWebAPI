...
It tries to reflect models and methods from documentation for easier use but there are
some limitations due to documentation inaccurancies and C# / Python environment differences.
